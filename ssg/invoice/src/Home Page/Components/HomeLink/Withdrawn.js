                    ...
                    <HomeLinkModal>
                            <ModalHeader>
                                ...
                                <ModalContentSection1 className = "eye-contant">
                                    ...
                                    <ModalContentElementsSection1><span>Withdraw Description:</span></ModalContentElementsSection1>
                                    <ModalContentElementsSection1 className="to-right">{ modal.StatusDescription }</ModalContentElementsSection1>
