                    ...
                    <HomeLinkModal>
                            <ModalHeader>
                                ...
                                <ModalContentSection1 className = "eye-contant">
                                    ...
                                    <ModalContentElementsSection2><span>Worklog Description:</span></ModalContentElementsSection2>
                                    <ModalContentElementsSection2 className="to-right">{ modal.Worklog }</ModalContentElementsSection2>
